import { asDiscreteSlot, unpackSlots } from "@/slots";
...
describe("Slots", () => {
    describe("Discrate slots", () => {
        const testSlots = {
            first: Object.assign(Object.assign({}, sharedSlot), { start: dayjs("2024-08-10").utc().format(), end: null, time: Time.from("1am").utc().format(), duration: 180, weekday: -1, repeat: ISlot.Repeat.Daily }),
            second: Object.assign(Object.assign({}, sharedSlot), { start: dayjs("2024-08-10").utc().format(), end: null, time: Time.from("12pm").utc().format(), duration: 180, weekday: -1, repeat: ISlot.Repeat.Daily }),
            third: Object.assign(Object.assign({}, sharedSlot), { start: dayjs("2024-08-10").utc().format(), end: dayjs("2024-08-15").utc().format(), time: Time.from("1am").utc().format(), duration: 180, weekday: -1, repeat: ISlot.Repeat.Daily }),
        };
        ...
        it("should unpack slot to a discrate date (4)", () => {
            expect(asDiscreteSlot(testSlots.first, dayjs.utc("2024-08-07"))).to.be.of.length(0);
            expect(asDiscreteSlot(testSlots.first, dayjs.utc("2024-08-08"))).to.be.of.length(0);
            expect(asDiscreteSlot(testSlots.first, dayjs.utc("2024-08-09"))).to.be.of.length(1);
            expect(asDiscreteSlot(testSlots.first, dayjs.utc("2024-08-10"))).to.be.of.length(2);
            expect(asDiscreteSlot(testSlots.first, dayjs.utc("2024-08-11"))).to.be.of.length(2);
        });
        it("should unpack slot to a discrate date (5)", () => {
            expect(asDiscreteSlot(testSlots.second, dayjs.utc("2024-08-09"))).to.be.of.length(0);
            expect(asDiscreteSlot(testSlots.second, dayjs.utc("2024-08-10"))).to.be.of.length(1);
            expect(asDiscreteSlot(testSlots.second, dayjs.utc("2024-08-11"))).to.be.of.length(1);
        });
    ...
    describe("Unpack daily slots", () => {
        it.skip("should unpack daily slots (case 1)", () => {
            const slot = Object.assign(Object.assign({}, sharedSlot), { start: dayjs("2024-08-10").utc().format(), end: null, time: Time.from("1am").utc().format(), duration: 180, weekday: -1, repeat: ISlot.Repeat.Daily });
