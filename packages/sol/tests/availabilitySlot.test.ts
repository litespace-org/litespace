...
describe("AvailabilitySlot", () => {
  it("should divide a slot into discrete number of subslots", () => {
    ...
    expect(subslots).to.have.deep.members(range(0,8).map(i => 
      ({
        parent: 1, 
    ...
    expect(subslots).to.have.deep.members(range(0,4).map(i => 
      ({
        parent: 1, 
    ...
    expect(subslots).to.have.deep.members(range(0,2).map(i => 
      ({
        parent: 1, 
