  ...
  return (
    <button
      ...
      className={cn(
        ...
        {
          "tw-text-natural-50 tw-border tw-bg-brand-700 tw-border-brand-700 hover:tw-bg-brand-800 hover:tw-border-brand-800 focus-visible:tw-bg-brand-900 focus-visible:tw-border-brand-200 dark:tw-bg-brand-400 dark:tw-text-secondary-900 dark:hover:tw-bg-brand-500 dark:focus-visible:tw-bg-brand-700 dark:focus-visible:tw-text-natural-50 dark:focus-visible:tw-border-brand-100":
