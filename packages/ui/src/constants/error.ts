...
export const apiErrorMap: Record<ApiErrorCode, LocalId> = {
  ...
  [ApiError.ShortVideoDur]: "error.api.short-video-dur",
  [ApiError.LongVideoDur]: "error.api.long-video-dur",
  ...
  [ApiError.LessonNotStarted]: "error.api.lesson-not-started",
  [ApiError.LessonTimePassed]: "error.api.lesson-time-passed",
  [ApiError.LessonAlreadyStarted]: "error.api.lesson-already-started",
