...
export const PlanCard: React.FC<Props> = ({
  ...
  return (
    ...
    >
      {label ? (
        <Typography
          element={isLargeScreen ? "body" : "tiny-text"}
          weight={isLargeScreen ? "semibold" : "regular"}
          className={cn(
      ...
      <div>
        <div className="tw-flex tw-items-center tw-gap-4 tw-mb-1 md:tw-mb-2">
          <Typography
            element={isLargeScreen ? "subtitle-2" : "caption"}
            weight="bold"
            className={cn(
      ...
      <div className={cn("tw-flex tw-flex-col")}>
        <Typography
          element={isLargeScreen ? "h4" : "body"}
          weight="bold"
          className={cn(
            isLargeScreen ? "tw-mb-2" : "tw-mb-1",
        ...
        <div className={cn("tw-flex tw-items-end tw-flex-wrap")}>
          <Typography
            element={isLargeScreen ? "subtitle-1" : "caption"}
            weight={isLargeScreen ? "bold" : "semibold"}
            className={cn(
              "tw-me-2",
              primary ? "tw-text-natural-50" : "tw-text-natural-950"
            )}
