  ...
  return (
    <>
      <div
        ...
        className="absolute top-11 border border-natural-200 shadow-select-menu rounded-lg w-fit min-w-36 max-w-64 bg-natrual-0 py-2 hidden data-[show=true]:block"
        style={{ left }}
        dir="ltr"
        tabIndex={1}
      >
