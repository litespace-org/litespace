  ...
  return (
    <div className="tw-flex tw-items-center tw-justify-center tw-gap-2">
      ...
      <Typography
        element="caption"
        className={cn(
          "tw-hidden tw-rounded-full lg:tw-flex tw-items-center tw-justify-center tw-text-natural-50 tw-font-bold tw-h-16 tw-backdrop-blur-[15px] tw-p-4 tw-bg-background-internet"
        )}
      >
        {alert}
      </Typography>
