...
export const Stepper: React.FC<{ step: Step }> = ({ step }) => {
  ...
  return (
    <div className="tw-flex tw-flex-row tw-justify-center tw-gap-4 md:tw-gap-6">
      {steps.map(({ index, label }) => {
        ...
        return (
          <div
            key={index}
            className="tw-flex tw-flex-col tw-w-min tw-gap-[3px] md:tw-gap-2"
          >
            <div className="tw-flex tw-flex-row tw-gap-1 md:tw-gap-4 tw-items-center">
              <div
                className={cn(
                  "tw-w-5 tw-h-5 md:tw-w-7 md:tw-h-7 tw-rounded-full tw-overflow-hidden tw-flex tw-items-center tw-justify-center",
                  {
              ...
              <div className="tw-h-[2px] tw-w-[46px] md:tw-w-[83px] tw-bg-natural-400">
                <div
            ...
            <Typography
              element="tiny-text"
              className={cn("tw-text-center md:tw-text-start", {
