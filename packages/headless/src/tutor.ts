...
export function useFindTutorById(
  ...
  return useQuery({
    queryKey: [QueryKeys.FindTutorById, id],
...
export function useFindTutorStats(
  ...
  return useQuery({
    ...
    queryKey: [QueryKeys.FindTutorStats, id],
    enabled: !!id,
    retry: false,
  });
}
...
export function useFindTutorActivityScore(
  ...
  return useQuery({
    ...
    queryKey: [QueryKeys.FindTutorActivity, id],
    enabled: !!id,
    retry: false,
  });
}

export function useFindUnpackedTutorRoles({
  interviewer,
  start,
  end,
}: {
  ...
  return useQuery({
    ...
    queryKey: [QueryKeys.FindInterviewSlots],
    enabled: !!interviewer,
  });
}
...
export function useShareFeedback(
  ...
  return useMutation({
    mutationFn: share,
    mutationKey: [MutationKeys.ShareFeedback],
  });
}
