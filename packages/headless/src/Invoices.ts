...
export function useFindInvoicesByUser(
  ...
  return usePaginationQuery(findInvoices, [QueryKeys.FindInvoicesByUser]);
}
...
export function useFindInvoiceStats(
  ...
  return useQuery({
    queryFn: findStats,
    queryKey: [QueryKeys.FindInvoiceStats],
    enabled: !!profile,
  });
}
...
export function useFindWithdrawalMethods() {
  ...
  return useQuery({
    ...
    queryKey: [QueryKeys.FindWithdrawalMethods],
  });
}
...
export function useEditUserInvoice({
  ...
  return useMutation({
    ...
    mutationKey: [MutationKeys.EditInvoice],
    onSuccess,
    onError,
  });
}
