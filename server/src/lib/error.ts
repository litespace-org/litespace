...
export const userAlreadyTyped = new ResponseError(errors.userAlreadyTyped, 400);
export const tutorHasNoTime = new ResponseError(errors.tutorHasNotTime, 400);
...
export const lessonNotFound = new ResponseError(errors.lessonNotFound, 404);
export const ratingNotFound = new ResponseError(errors.ratingNotFound, 404);
export const alreadyRated = new ResponseError(errors.alreadyRated, 400);
export const alreadySubscribed = new ResponseError(
  errors.alreadySubscribed,
  400
);
export const subscriptionNotFound = new ResponseError(
