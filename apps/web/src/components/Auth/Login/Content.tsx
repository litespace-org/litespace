...
const Content: React.FC = () => {
  ...
  return (
    <main className="flex flex-col gap-10 sm:gap-0 items-center justify-start w-full max-w-[392px] p-6">
      <div className="flex-1 flex flex-col gap-8 sm:justify-center w-full">
        <Title type="login" />
