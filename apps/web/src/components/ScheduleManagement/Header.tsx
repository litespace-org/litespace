...
const Header: React.FC<Props> = ({
  ...
  return (
    <div className="bg-natural-50 md:bg-transparent rounded-b-3xl md:rounded-none shadow-day-slot md:shadow-[none] -m-4 p-4 md:m-0 md:p-0 relative flex flex-col md:flex-row justify-between md:items-center gap-6">
      <div>
        <Typography
          tag="h2"
        ...
        >
          ...
          {lg || !md
            ...
            : date.add(3, "days").endOf("day").format("DD MMMM YYYY")}
        </Typography>
      </div>
