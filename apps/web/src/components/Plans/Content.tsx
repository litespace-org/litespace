  ...
  return (
    <div>
      <div className="flex flex-col gap-2 md:gap-4 justify-center items-center text-center mb-16">
        ...
        <Typography
          element={lg ? "subtitle-1" : "tiny-text"}
          weight={lg ? "semibold" : "regular"}
                ...
                {value === "annual" ? (
                  <>
                    ...
                    <div
                      ...
                      className="absolute -bottom-10 md:-bottom-[35px] -left-0 md:-left-[115%] w-7 md:w-[35px] h-[15px]"
                    >
                      <CurvedDashedLine />
                    </div>
                  </>
