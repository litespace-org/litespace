import { ITab } from "@/components/StudentSettings/Content";
      ...
      >
        {tabs.map(({ id, Icon, label }) => {
          ...
          return (
            ...
            >
              {Icon ? (
                <Icon className="w-6 h-6 [&>*]:stroke-[1.5px] [&>*]:stroke-natural-700 [&>*]:fill-transparent me-4" />
              ) : null}
              ...
              <Button
                ...
                startIcon={
                  <LeftArrowHead className="w-6 h-6 [&>*]:stroke-natural-700 -mt-1" />
                }
              />
            </div>
          );
