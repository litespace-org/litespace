...
const Ratings: React.FC<{ id: number; tutorName: string | null }> = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col justify-center p-4 lg:py-8 md:px-10",
    ...
    >
      {isEmpty(ratings) ? (
        ...
        <div className="grid gap-4 flex-wrap justify-center grid-cols-[repeat(auto-fill,minmax(256px,310px))] lg:grid-cols-[repeat(auto-fill,minmax(256px,1fr))]">
