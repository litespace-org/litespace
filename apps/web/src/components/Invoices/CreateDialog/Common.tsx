...
export const AmountAndMethod: React.FC<{
  amount?: number;
  amountState?: "error" | undefined;
  amountHelper?: string | undefined;
  setAmount: (val: number) => void;
  method?: IInvoice.WithdrawMethod;
  methodState?: "error" | undefined;
  methodHelper?: string | undefined;
  ...
  return (
    <div className="flex flex-row items-start gap-6 [&>*]:flex-1">
      <NumericInput
        id="amount"
        label={intl("invoices.dialog.create.amount")}
        dir="rtl"
        placeholder={intl("invoices.dialog.create.amount-placeholder")}
      ...
      <Select
        id="method"
        label={intl("invoices.dialog.create.withdrawal-method")}
        asButton={isEmpty(options)}
        options={options}
        placeholder={intl(
          "invoices.dialog.create.withdrawal-method.placeholder"
        )}
        value={method}
        state={methodState}
  ...
  return (
    <div className="flex gap-6">
      ...
      >
        ...
        >
          {intl("invoices.dialog.create.btn-label")}
        </Typography>
      </Button>
      <Button
        className="flex-1"
