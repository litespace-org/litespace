...
const SessionExample: React.FC<{
  ...
  return (
    <div className="w-[569px] mx-auto mt-[60px] flex flex-col items-center">
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2 items-center text-center">
          ...
          <Dialog
            ...
            headless
          >
            <VideoPlayer src="https://litespace-prod-assets.fra1.cdn.digitaloceanspaces.com/4ea88b90-dc5b-4b31-9131-fa2da1475ce3" />
          </Dialog>
        </div>
      ...
      {showExample ? (
        <Link
          to="https://web.telegram.org/k/#@MahmoudNagaty"
