...
export const SuggestedTutors: React.FC<{
  ...
  return (
    <>
      ...
      <div className="lg:hidden flex flex-col gap-6 md:mx-0 md:grid md:gap-4 md:grid-cols-3 xl:grid xl:grid-cols-3 xl:gap-6">
        {tutors.map((tutor) => (
          <TutorCard
            key={tutor.id}
            tutorId={tutor.id}
            ...
            buttonSize="large"
            cardHeight="h-[224px] lg:h-[298px]"
          />
        ))}
      </div>

      <div className="hidden xl:hidden lg:grid lg:grid-cols-2 gap-4">
