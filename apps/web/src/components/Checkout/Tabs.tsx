...
const Header: React.FC<{ tab: Tab; setTab(tab: Tab): void }> = ({
  ...
  return (
    <div className="flex items-center justify-center mb-4 md:mb-10 lg:mb-8">
      <Tabs<Tab>
        tab={tab}
        setTab={setTab}
        tabs={[
...
const Body: React.FC<{
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-10 lg:min-w-[1004px] _px-10">
      <PaymentPannel
        planId={plan.id}
        tab={tab}
        phone={phone}
