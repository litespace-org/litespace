...
export class WebDeviceManager implements DeviceManager {
  ...
  async listDevices(): Promise<Device[]> {
    // TODO: make it more reliable: auto detect
    ...
    await navigator.mediaDevices
      ...
      .catch(() => console.error("counldn't get access to user media"));
...
export function makeCall(
  ...
  return new CallManager(
    new LivekitCallSession(memberIds[0], memberIds, ext),
    new WebDeviceManager()
  );
}
