...
const Complete: React.FC = () => {
  ...
  return (
    <div className="flex flex-row justify-between xl:justify-center gap-6 h-full p-6">
      <main className="flex flex-col justify-center items-center gap-8 w-full max-w-[496px] p-6">
