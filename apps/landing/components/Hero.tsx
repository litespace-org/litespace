...
import { LottieAnimate } from "./Common/LottieAnimate";
...
const Hero: React.FC = () => {
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col lg:flex-row items-center justify-center gap-10 bg-natural-0 overflow-hidden h-auto lg:min-h-[720px] pt-[72px] mt-14 sm:mt-16 lg:mt-0 lg:px-20"
      )}
    >
