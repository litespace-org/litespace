...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mx-auto max-w-screen-3xl overflow-hidden relative text-natural-50 flex items-center justify-center p-4 md:p-8 lg:px-0 lg:pt-[72px] lg:pb-[42px] bg-natural-0">
