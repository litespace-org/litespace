      ...
      >
        <div className="py-6 flex flex-col gap-6">
          <Input
            autoFocus
            id="email"
            placeholder={intl("dashboard.tutor.form.email.placeholder")}
          ...
          <Password
            ...
            idleDir="rtl"
            autoComplete="off"
            label={intl("dashboard.tutor.form.password.label")}
            placeholder={intl("dashboard.tutor.form.password.placeholder")}
